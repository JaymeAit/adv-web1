...
<a id="btnEmpty" href="luggageBags.php?action=emptyW">clear wish list</a>
<?php
if(isset($_SESSION["WishL"])){
    $total_quantity = 0;
    $total_price = 0;
...
<?php		
    ...
    foreach ($_SESSION["WishL"] as $KEYS => $values){
        ...
        <td style="text-align:center;">
               ...
               <form method="post" action="luggageBags.php?action=deleteW&code="<?php echo $values["item_name"];?>"">
...
<a id="btnEmpty" href="luggageBags.php?action=empty">Empty Cart</a>
<?php
if(isset($_SESSION["SC"])){
    $total_quantity = 0;
    $total_price = 0;
...
<?php		
    ...
    <td><?php echo $values["item_quantity"];?> </td>
        ...
        <td style="text-align:center;">
               ...
               <form method="post" action="luggageBags.php?action=delete&code="<?php echo $values["item_name"];?>"">
...
{?>
        ...
        <form method="post" action="luggageBags.php?action=add&code="<?php echo $row["itemName"];?>"">
