...
<a id="btnEmpty" href="canvasBags.php?action=emptyW">clear wish list</a>
<?php
if(isset($_SESSION["WishL"])){
    $total_quantity = 0;
    $total_price = 0;
...
<?php		
    ...
    foreach ($_SESSION["WishL"] as $KEYS => $values){
        ...
        <td style="text-align:center;">
               ...
               <form method="post" action="canvasBags.php?action=deleteW&code="<?php echo $values["item_name"];?>"">
...
<input type="hidden" id="itemName" name="itemName1" value= "<?php echo $value123 ?>">
